 ...
 */
@Path("/0/api/mobilerecharge/cu/plain")
public class CUPlainSmsResource {

    private final static Logger logger = LoggerFactory.getLogger(CUPlainSmsResource.class);
    ...
    public Response getSms(@QueryParam("code")String shortcode,
        ...
        logger.debug("cu plain sms read request code with shortcode:[{}], orderno:[{}]", shortcode, orderno);
        ...
        ServiceResult<SmsRecharge> serviceResult = sdkNoticeService.cuPlainSmsNotice(shortcode, orderno, fee);
