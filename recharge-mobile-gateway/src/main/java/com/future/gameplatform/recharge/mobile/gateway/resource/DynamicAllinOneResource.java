 ...
 */
@Path("/0/api/mobilerecharge/all/dynamic")
public class DynamicAllinOneResource {

    private final static Logger logger = LoggerFactory.getLogger(DynamicAllinOneResource.class);
    ...
    public Response getSms(@QueryParam("code")String shortcode,
        ...
        logger.debug("dynamic all in one request code with code:[{}], orderno:[{}], fee:[{}], channel:[{}], sign:[{}]",new Object[] {shortcode, orderno, fee, channel, sign});
        ...
        ServiceResult<SmsRecharge> serviceResult = sdkNoticeService.dynamicAllinoneNotice(shortcode, orderno, fee, channel);
