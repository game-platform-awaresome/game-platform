 ...
 */
@Path("/0/api/mobilerecharge/cmcc/dynamic/game")
public class CMCCDynamicGameResource {

    private final static Logger logger = LoggerFactory.getLogger(CMCCDynamicGameResource.class);
    ...
    public Response getSms(@QueryParam("code")String shortcode,
        ...
        ServiceResult<SmsRecharge> serviceResult = sdkNoticeService.cmccDynamicGameNotice(shortcode, orderno, fee);
