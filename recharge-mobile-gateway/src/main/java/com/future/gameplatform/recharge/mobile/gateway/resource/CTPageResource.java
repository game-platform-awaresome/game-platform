 ...
 */
@Path("/0/api/mobilerecharge/ct/page")
public class CTPageResource {

    private final static Logger logger = LoggerFactory.getLogger(CTPageResource.class);
    ...
    public Response getRechargeSmscode(@QueryParam("code")String shortCode,
        ...
        ServiceResult<String> serviceResult = sdkNoticeService.ctpageNotice(shortCode, orderno, mobile, fee, channel);
    ...
    @Path("/result")
    @Produces(MediaType.APPLICATION_JSON)
    public Response getRechargeResult(@QueryParam("code")String shortCode, @QueryParam("orderno")String orderno, @QueryParam("smscode")String smscode,@QueryParam("sign")String sign){
        ...
        ServiceResult<String> serviceResult = sdkNoticeService.ctpageResult(shortCode, orderno, smscode);
        if(serviceResult.isSuccess()){
            result.put("rtCode","000");
            result.put("rtMsg","success");
            return Response.ok(result).build();
