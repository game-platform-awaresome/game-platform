 ...
 */
@Path("/0/api/mobilerecharge/cu/sms")
public class SMSDirectCUResource {
    ...
    public Response notify(@QueryParam("code")String shortcode,
        ...
        logger.debug("cu sms direct notice with shortcode:[{}], sms:[{}]", shortcode, sms);
        ...
        ServiceResult<String> serviceResult = sdkNoticeService.smsDirectCUNotice(shortcode, orderno, null, sms, fee, channel);
