 ...
 */
@Path("/0/api/mobilerecharge/cu/plaingame")
public class CUPlainSmsGameResource {

    private final static Logger logger = LoggerFactory.getLogger(CUPlainSmsGameResource.class);
    ...
    public Response getSms(@QueryParam("code")String shortcode,
        ...
        logger.debug("cu plain sms gage request code with shortcode:[{}], orderno:[{}]", shortcode, orderno);
        ...
        ServiceResult<SmsRecharge> serviceResult = sdkNoticeService.cuPlainSmsGameNotice(shortcode, orderno, fee);
