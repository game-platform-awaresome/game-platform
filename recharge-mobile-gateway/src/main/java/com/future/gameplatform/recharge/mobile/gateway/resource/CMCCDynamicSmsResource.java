 ...
 */
@Path("/0/api/mobilerecharge/cmcc/dynamic/sms")
public class CMCCDynamicSmsResource {

    private final static Logger logger = LoggerFactory.getLogger(CMCCDynamicSmsResource.class);
    ...
    public Response getSms(@QueryParam("code")String shortcode,
        ...
        ServiceResult<SmsRecharge> serviceResult = sdkNoticeService.cmccDynamicSmsNotice(shortcode, orderno, fee);
